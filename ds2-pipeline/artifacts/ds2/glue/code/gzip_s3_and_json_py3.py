...
from config import AWS_REGION, AWS_SECRET_NAME, SKILL_CREDENTIALS
...
def retrieve_access_token() -> str:
    ...
    try:
        ...
        token_url: str = 'https://skill.straumann.com/connect/token'
        refresh_token: Optional[str] = None
        token_manager: TokenManager = TokenManager(token_url=token_url, credentials=SKILL_CREDENTIALS, refresh_token=refresh_token)
