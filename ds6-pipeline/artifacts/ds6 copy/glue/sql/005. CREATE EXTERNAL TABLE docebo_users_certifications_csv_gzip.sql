CREATE EXTERNAL TABLE IF NOT EXISTS `stg-dlk-sbx-ds6-raw-db`.docebo_users_certifications_csv_gzip 
    (
         `Username`                                                 string
        ,`Account code`                                             string
        ...
        ,`Certification Description`                                string
        ,`Certification Duration`                                   string
        ,`Certification Status`                                     string
        ,`Completed Activity`                                       string
        ,`Issued on`                                                string
        ,`To renew in`                                              string
    )
...
LOCATION 's3://stg-dlk-sbx-ds-6-raw/docebo_feed/Users_Certifications'
