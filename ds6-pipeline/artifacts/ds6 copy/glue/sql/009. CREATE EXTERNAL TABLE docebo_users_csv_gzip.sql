CREATE EXTERNAL TABLE IF NOT EXISTS `stg-dlk-sbx-ds6-raw-db`.docebo_users_csv_gzip 
    (
         `Username`                                               string
        ,`Account code`                                           string
        ...
        ,`Authenticator App Paired`                               string
        ,`Branch Name`                                            string
        ,`Branch path`                                            string
...
LOCATION 's3://stg-dlk-sbx-ds-6-raw/docebo_feed/Users'
