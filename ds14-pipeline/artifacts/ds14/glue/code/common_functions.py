...
from config import AWS_REGION, AWS_BUCKET,  AWS_ATHENA_DATABASE, AWS_ATHENA_OUPUT, SQL_QUERIES_BUCKET, SQL_QUERIES_FOLDER, S3_DESTINATION_BUCKET, S3_DESTINATION_PATH, SNS_FAILURE_TOPIC
