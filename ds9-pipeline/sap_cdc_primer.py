...
# Construct API URL
url: str = f'https://accounts.eu1.gigya.com/accounts.search?apiKey=3_sUuYY3aPXsYTusEqibJXwme9HwNRxM-N3_Wx2Z4HV3X47ft6BZY-JzcA2kBMaPcy&userKey=ADwPPFXaaoAn&secret=2lm93KoFJBKPvrKfdc5qFx5oqcbx5TcX&query=SELECT%20UID%20FROM%20accounts%20limit%2010000&timeout=60000&context=awsglue&httpStatusCodes=true&openCursor=true'
