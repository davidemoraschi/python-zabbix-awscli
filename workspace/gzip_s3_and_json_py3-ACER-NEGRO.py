...
def get_secret_credentials(aws_region: str, aws_secret_name: str) -> dict:
    ...
    try:
        ...
        print(f"Error retrieving secret credentials: {str(e)}")
        return {}


def upload_json_gz(logger, s3client, bucket, key, obj, default=None, encoding='utf-8'):
