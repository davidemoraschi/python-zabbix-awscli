...
def main():
    ...
    try:
        ...
        response = sns.publish(TopicArn='arn:aws:sns:eu-west-1:816247855850:ds6-failure-topic',
            Message=f'WORKFLOW_NAME.WORKFLOW_RUN_ID|JOB_NAME.JOB_RUN_ID: {WORKFLOW_NAME}.{WORKFLOW_RUN_ID}|{JOB_NAME}.{JOB_RUN_ID}|{str(exc)}')
        log('end-job')
        raise
