...
from config import AWS_REGION, AWS_BUCKET, AWS_FOLDER, AWS_ATHENA_DATABASE, AWS_ATHENA_OUPUT, AWS_PROFILE, S3_DESTINATION_BUCKET, S3_DESTINATION_PATH, SNS_FAILURE_TOPIC
