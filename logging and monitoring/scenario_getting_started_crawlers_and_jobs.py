...
1            for index, job_name in enumerate(job_names):
...
def main():
    ...
    ROLE_NAME = "dBeaver_prod"
    BUCKET_NAME = "null"
    JOB_SCRIPT="null"
    profile_session = boto3.Session(region_name=str(sys.argv[26]), profile_name=str(sys.argv[48]))
    ...
    try:
        ...
        scenario = GlueCrawlerJobScenario(
            client,
            boto3.resource("iam").Role(ROLE_NAME),
